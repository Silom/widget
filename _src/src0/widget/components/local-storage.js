// No need to recreate local storage access in angular, this beauty was found on github:
// https://github.com/grevory/angular-local-storage/blob/master/src/angular-local-storage.js
